...
class notif_offering_show extends StatefulWidget {
  final id;
  notif_offering_show({
    this.id,
  });
  ...
  @override
  _notif_offering_showState createState() => _notif_offering_showState();
}

class _notif_offering_showState extends State<notif_offering_show> {
  ...
  String no_hp,
      ...
      upah,ttd,
      mulai_kerja,
      selesai_kerja,penempatan,client,
      status_perkawinan;
  ...
  Future getTerms(employee_id) async {
    loading = false;
    final jsonString =
        await http.post(NetworkConfig().baseUrl + "apps/dw_term_detail", body: {
    ...
    setState(() {
      id_dw_active = terms.id.toString();
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                      "Perjanjian Kerja Harian Lepas ini (selanjutnya disebut “PERJANJIAN”) dibuat dan ditandatangani pada hari ini ( ) oleh dan di antara :"),
                ),
                SizedBox(height: 16),
                Padding(
                  padding: const EdgeInsets.all(8.0),
...
//                      Text("II"),
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                      "2.Perusahaan melakukan pembayaran Upah pada tanggal 10 (sepuluh) setiap bulannya setelah KARYAWAN memberikan hasil pekerjaannya, jika tanggal pada hari tersebut hari libur maka pembayaran dilakukan setelah tanggal tersebut."),
                ),
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: Text(
                ...
                Row(
                  ...
                  children: <Widget>[
                    ...
                    Image.asset("images/slider/cap.png",width: 200,height: 100,),
                    Column(
                        children: [
                          Image.network(ttd==null?"":ttd,height: 100,width: 150,),
